...
FEATURES = [
    ...
    "BsmtQual_TotalSF", "Neighborhood_Qual", "Neighborhood_SF",
    "GrLivArea_ratio", "GarageCars", "GarageArea", "GarageFinish_num",
    "GarageScore", "KitchenScore", "TotalQual", "HasFireplace", "Fireplaces",
    "TotalBsmtSF", "YearBuilt", "FullBath", "TotRmsAbvGrd", "YearRemodAdd",
    "LotFrontage", "MasVnrArea", "WoodDeckSF", "OpenPorchSF", "BsmtFinSF1",
    "OverallCond", "LotArea", "Condition1", "LotShape", "LandContour",
    "Functional_num", "MSZoning_num", "SaleCondition_num", "ExteriorQual",
    "BsmtScore", "ConditionScore", "Qual_Remod", "Garage_SF", "Bsmt_Liv",
    "Lot_Score",
]