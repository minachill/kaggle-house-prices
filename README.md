...
1. [Kaggle のデータページ](https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques/data)から `train.csv`, `test.csv` をダウンロードし、`data/` に配置する
...
3. ノートブックを番号順（`00_baseline.ipynb` → `05_ensemble.ipynb`）に実行する
